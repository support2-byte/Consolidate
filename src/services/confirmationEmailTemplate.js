...
<div class="card">
  ...
  <div class="content">
    ...
    ${
      otp
        ? `<div class="info-box" style="border-left-color: #097D76; margin-top: 16px;">
      <div class="info-title">
        <i class="fas fa-shield-halved"></i>
        Verification Code
      </div>
      <p style="margin: 0 0 4px; font-size: 28px; font-weight: 700; letter-spacing: 6px; color: #097D76; text-align: center;">${otp}</p>
      <p style="margin: 0; font-size: 13px; color: #64748b; text-align: center;">Use this code to verify your booking confirmation. Do not share it with anyone.</p>
    </div>`
        : ""
    }
  </div>
